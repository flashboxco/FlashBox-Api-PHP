...
namespace FlashBox\Exception;


use Throwable;

class FlashBoxApiException extends \Exception
{
    /**
     * FlashBoxApiException constructor.
    ...
    public function errorMessage()
    {
        ...
        $errorMsg .= "<h1 style='color: #dd6252'>FlashBox Exception:</h1>";
